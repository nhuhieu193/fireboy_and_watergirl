...
GameStage5* GameStage5::s_Instance = NULL;

GameStage5::GameStage5() {
    Engine::GetInstance() -> CurrentMap = new Map("5");
...
void GameStage5::UpdateStageOver() {
    if (StageOver) return;
